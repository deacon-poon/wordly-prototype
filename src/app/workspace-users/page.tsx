 ...
 *
 * Anatomy (mirrors the template): MainContainer with title "{workspace}'s Users",
 * a description, a primary "Add Users to Workspace" action, and content that is
 * either an empty state or a list of users (name + email + destructive delete).
 * Add uses the ported UserSelectorDialog; delete uses ConfirmationDialog.
 *

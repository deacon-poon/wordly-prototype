 ...
 *
 * MainContainer (title/description/content/footer) wrapping the workspace
 * session-defaults form: Pool of Minutes (AccountSelector), Glossary
 * (GlossarySelector), Save transcript (radio), Floor Audio (checkbox), Voice
 * (VoiceSelector), Default input language + Speaker's languages (LanguageSelector),
 * and Auto-switch input language (radio); footer Save button.
 *

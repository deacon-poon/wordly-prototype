...
export function SessionEditDrawer({
  ...
  const handleRemoveLanguage = (langCode: string) => {
    setFormData({
      ...formData,
      selections: formData.selections.filter((code: string) => code !== langCode),
    });
  };
  ...
  const handleSave = () => {
    if (session) {
      ...
      const [startHour, startMin] = formData.scheduledStart.split(":").map(Number);
      ...
      const endTime = `${adjustedEndHour.toString().padStart(2, '0')}:${adjustedEndMin.toString().padStart(2, '0')}`;
      ...
      <div className="flex-1 overflow-y-auto px-6 py-4 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.account} onValueChange={(value) => setFormData({ ...formData, account: value })}>
                ...
                <SelectContent>
                  <SelectItem value="deacon-poon-2a49e">Deacon Poon (2a49e)</SelectItem>
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.autoSelect} onValueChange={(value) => setFormData({ ...formData, autoSelect: value })}>
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.glossary} onValueChange={(value) => setFormData({ ...formData, glossary: value })}>
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.transcript} onValueChange={(value) => setFormData({ ...formData, transcript: value })}>

    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] p-0 overflow-hidden">
        ...
        <div className="px-6 pb-6 space-y-4">
          ...
          <Card
            className="relative p-5 border-2 border-gray-200 hover:border-primary-blue-400 hover:bg-primary-blue-50/30 cursor-pointer transition-all group"
            onClick={() => {
              onOpenChange(false);
              onChooseSpreadsheet();
            }}
          >
            <div className="flex items-start gap-4">
              <div className="flex-shrink-0 w-12 h-12 rounded-lg bg-primary-blue-100 flex items-center justify-center">
                <FileSpreadsheet className="h-6 w-6 text-primary-teal-600" />
              </div>
              <div className="flex-1 min-w-0">
                <h3 className="font-semibold text-gray-900 mb-1 flex items-center gap-2">
                  Create from Spreadsheet
                  <span className="text-xs font-normal px-2 py-0.5 bg-primary-blue-100 text-primary-blue-800 rounded-full">
                    Recommended
                  </span>
                </h3>
